...
class TensorList(Operator):
    ...
    def parse(self):
        ...
        if self.operator_code == 'TensorListReserve':
            ...
            self.model.constant[self.outputs[0]] = tf.raw_ops.TensorListReserve(element_shape=element_shape, num_elements=num_elements, element_dtype=element_dtype, name=None)
