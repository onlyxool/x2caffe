...
class Mul(Operator):
    ...
    def convert(self):
        ...
        if self.type == 'Eltwise':
            ...
            layers.append(caffe_layer('Scale', 'Scale'+str(self.index), [self.inputs[0], self.inter_blob], self.inputs_buf, self.outputs, self.weight, self.bias, scale_param=self.scale_param))
